...
non_terminals = ['T', 'E']#raw_input("Enter the non-terminals (separated by ',') : ").split(',')

m = 2#int(raw_input("Enter the number of terminals : "))
terminals = ['a', '+']#raw_input("Enter the terminals (separated by ',') : ").split(',')
